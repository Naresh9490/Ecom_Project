            ...
            <div className="container py-5 my-5">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex justify-content-center">
                        <img src="https://png.pngtree.com/png-vector/20220609/ourmid/pngtree-assets-management-rgb-color-icon-for-dark-theme-png-image_4845371.png" alt="About Us" height="400px" width="400px" />
                    </div>
                </div>
            </div>
        </div>
